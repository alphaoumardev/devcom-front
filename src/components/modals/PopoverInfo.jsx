...
const PopoverInfo = ({item, my_profile})=>
{
    ...
    return(
        <div className=" w-56 h-40 pb-3 transition-opacity duration-300 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                ...
                <div>
                    ...
                    <>
                        ...
                        <button type="button"
                                ...
                                className="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Unfollow
                        </button>:
                        <button type="button"
                                onClick={()=>dispatch(followProfileAction(item?.profile?.id))}
                                className="text-white bg-blue-700 hover:bg-red-400 focus:ring-4 focus:ring-red-500 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-red-500 dark:hover:bg-red-500 focus:outline-none dark:focus:ring-blue-800">Follow
                        </button>}
                    </>
                    }
                </div>
            ...
            <div className="mb-4 text-sm font-light ">{item?.profile?.bio?.slice(0,40)} ...
                <a href="/" className="text-blue-600 dark:text-blue-500 hover:underline text-black">devco.com</a>.
            </div>
