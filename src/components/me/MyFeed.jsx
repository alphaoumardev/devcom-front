                        ...
                        <div className="w-full flex-col">
                            <div className="rounded relative">
                                ...
                                <div className="w-full">
                                    ...
                                    <span className="flex justify-center items-center text-blue-600 ">@{my_profile?.user?.username}</span>
                                    <p className="mt-2 text-gray-600 dark:text-gray-200 indent-6">{my_profile?.bio}</p>
                            ...
                            <div className="sm:hidden flex items-center justify-center">
                                <MyTabsMobile my_profile={my_profile} my_posts={my_posts} followedby={followedby}
                                              liked_posts={liked_posts} saved_posts={saved_posts}
                                              following={following}/>
                            </div>
