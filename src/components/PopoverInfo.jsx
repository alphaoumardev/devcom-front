    ...
    return(
        <div className=" w-56 h-40 pb-3 transition-opacity duration-300 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
            <div className="flex justify-between items-center mb-2">
                <a href="#">
                    <img className="object-cover w-10 h-10 rounded-full" src={userinfo?.avatar}  alt=""/>
                </a>
                <div>
            ...
            <p className="mb-3 text-sm font-normal">
                <a href="#" className="hover:underline">@{userinfo?.user?.username}</a>
            </p>
            <p className="mb-4 text-sm font-light">{userinfo?.bio?.slice(0,30)}
